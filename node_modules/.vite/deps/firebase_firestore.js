...
var ws = class {
  ...
  static createSynthesizedRemoteEventForCurrentChange(t2, e) {
    ...
    return n.set(t2, ms.createSynthesizedTargetChangeForCurrentChange(t2, e)), new ws(st.min(), n, _s(), ss(), fs());
  }
};
var ms = class {
  constructor(t2, e, n, s, i) {
...
var eu = class {
  constructor(t2, e, n, s, i, r, o, u) {
    this.Hs = t2, this.vo = n, this.Vo = s, this.So = i, this.authCredentialsProvider = r, this.appCheckCredentialsProvider = o, this.listener = u, this.state = 0, /**
     * A close count that's incremented every time the stream is closed; used by
     * getCloseGuardedDispatcher() to invalidate callbacks that happen after
     * close.
     */
    this.Do = 0, this.Co = null, this.xo = null, this.stream = null, this.No = new tu(t2, e);
  }
  /**
  ...
  async close(t2, e) {
    ...
    this.Do++, 4 !== t2 ? (
      ...
      (x2(e.toString()), x2("Using maximum backoff delay to prevent overloading the backend."), this.No.Ao())
...
var su = class extends eu {
  ...
  onMessage(t2) {
    if (
      ...
      M2(!!t2.streamToken), this.lastStreamToken = t2.streamToken, this.Yo
    ) {
      this.No.reset();
...
var ou = class {
  ...
  cu() {
    0 === this.ru && (this.au(
      "Unknown"
      /* Unknown */
    ), this.ou = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.ou = null, this.hu("Backend didn't respond within 10 seconds."), this.au(
      "Offline"
      /* Offline */
    ), Promise.resolve())));
  }
   ...
   */
  lu(t2) {
    "Online" === this.state ? this.au(
      "Unknown"
      /* Unknown */
    ) : (this.ru++, this.ru >= 1 && (this.fu(), this.hu(`Connection failed 1 times. Most recent error: ${t2.toString()}`), this.au(
      "Offline"
      /* Offline */
    )));
  }
   ...
   */
  set(t2) {
    this.fu(), this.ru = 0, "Online" === t2 && // We've connected to watch at least once. Don't warn the developer
    // about being offline going forward.
    (this.uu = false), this.au(t2);
  }
  au(t2) {
...
var uu = class {
  constructor(t2, e, n, s, i) {
     ...
     */
    this._u = /* @__PURE__ */ new Map(), /**
     * A set of reasons for why the RemoteStore may be offline. If empty, the
     * RemoteStore may start its network connections.
     */
    this.wu = /* @__PURE__ */ new Set(), /**
     ...
     */
    this.mu = [], this.gu = i, this.gu.qr((t3) => {
...
function lu(t2, e) {
  const n = $(t2), s = ku(n);
  n._u.delete(e), s.Oo() && du(n, e), 0 === n._u.size && (s.Oo() ? s.$o() : mu(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
      ...
      */
      function(t3, e3) {
        ...
        n2.targetMismatches.forEach((e4) => {
          ...
          if (!n3)
            return;
          t3._u.set(e4, n3.withResumeToken(Wt.EMPTY_BYTE_STRING, n3.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function Tu(t2, e, n) {
  ...
  t2.asyncQueue.enqueueRetryable(async () => {
    C2("RemoteStore", "Retrying IndexedDB access"), await n(), t2.wu.delete(
      1
      /* IndexedDbFailed */
    ), await cu(t2);
  });
...
async function Cu(t2, e) {
  e && Ou(t2).Xo && // This error affects the actual write.
  await async function(t3, e2) {
    if (n = e2.code, Zn(n) && n !== B2.ABORTED) {
      const n2 = t3.du.shift();
      Ou(t3).Fo(), await Eu(t3, () => t3.remoteSyncer.rejectFailedWrite(n2.batchId, e2)), // It's possible that with the completion of this mutation
...
async function xu(t2, e) {
  ...
  n.yu.set(
    "Unknown"
    /* Unknown */
  ), await n.remoteSyncer.handleCredentialChange(e), n.wu.delete(
    3
    /* CredentialChange */
  ), await cu(n);
}
...
function ku(t2) {
  ...
  (t2.Iu = function(t3, e, n) {
    ...
    e ? (t2.Iu.Fo(), wu(t2) ? _u(t2) : t2.yu.set(
      "Unknown"
      /* Unknown */
    )) : (await t2.Iu.stop(), gu(t2));
  })), t2.Iu;
}
function Ou(t2) {
  ...
  (t2.Tu = function(t3, e, n) {
    ...
    e ? (t2.Tu.Fo(), // This will start the write stream if necessary.
    await Au(t2)) : (await t2.Tu.stop(), t2.du.length > 0 && (C2("RemoteStore", `Stopping write stream with ${t2.du.length} pending writes`), t2.du = []));
  })), t2.Tu;
}
var Mu = class {
  constructor(t2, e, n, s, i) {
...
var Bu = class {
  ...
  track(t2) {
    ...
    n ? (
      ...
      0 !== t2.type && 3 === n.type ? this.Eu = this.Eu.insert(e, t2) : 3 === t2.type && 1 !== n.type ? this.Eu = this.Eu.insert(e, {
        type: n.type,
        doc: t2.doc
...
var Lu = class {
  ...
  isEqual(t2) {
    if (!(this.fromCache === t2.fromCache && this.syncStateChanged === t2.syncStateChanged && this.mutatedKeys.isEqual(t2.mutatedKeys) && hn(this.query, t2.query) && this.docs.isEqual(t2.docs) && this.oldDocs.isEqual(t2.oldDocs)))
      return false;
...
var zu = class {
  constructor(t2, e, n) {
     ...
     */
    this.Su = false, this.Du = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  xu(t2, e) {
    if (!t2.fromCache)
      return true;
    const n = "Offline" !== e;
    return (!this.options.ku || !n) && (!t2.docs.isEmpty() || "Offline" === e);
  }
  Cu(t2) {
  ...
  Nu(t2) {
    t2 = Lu.fromInitialDocuments(t2.query, t2.docs, t2.mutatedKeys, t2.fromCache), this.Su = true, this.Vu.next(t2);
  }
};
var Hu = class {
  constructor(t2, e) {
...
var ec2 = class {
  constructor(t2, e) {
    this.query = t2, this.Uu = e, this.qu = null, /**
  ...
  // PORTING NOTE: Multi-tab only.
  ec() {
    return Lu.fromInitialDocuments(this.query, this.Qu, this.mutatedKeys, 0 === this.qu);
  }
};
var nc2 = class {
  constructor(t2, e, n) {
...
async function rc2(t2, e) {
  ...
  if (r)
    ...
    s = t3.targetId, i = await oc2(n, e, s, "current" === r2);
  }
  return i;
}
async function oc2(t2, e, n, s) {
  ...
  const i = await Do(
    ...
    /* usePreviousResults= */
    true
  ), r = new ec2(e, i.Hi), o = r.Wu(i.documents), u = ms.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t2.onlineState), c = r.applyChanges(
    o,
    /* updateLimboDocuments= */
    t2.isPrimaryClient,
    u
  ...
  return t2.ic.set(e, a), t2.rc.has(n) ? t2.rc.get(n).push(e) : t2.rc.set(n, [e]), c.snapshot;
}
...
async function xc2(t2, e, n, s) {
  ...
  if (r && r.length > 0)
    switch (n) {
      case "current":
      case "not-current": {
        const t3 = await xo(i.localStore, _n(r[0])), s2 = ws.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
        await Ec2(i, t3, s2);
        break;
      }
      case "rejected":
...
var Lc2 = class {
  ...
  terminate() {
    return async function(t2) {
      const e = $(t2);
      C2("RemoteStore", "RemoteStore shutting down."), e.wu.add(
        5
        /* Shutdown */
      ), await au(e), e.gu.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var da2 = class {
  constructor(t2, e, n, s, i) {
    this.asyncQueue = t2, this.datastore = e, this.options = n, this.updateFunction = s, this.deferred = i, this.kc = n.maxAttempts, this.No = new tu(
      this.asyncQueue,
      "transaction_retry"
      /* TransactionRetry */
    );
...
function Ca(t2, e) {
  ...
  return t2.asyncQueue.enqueueAndForget(async () => function(t3, e2) {
    $(t3).bu.add(e2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    e2.next();
  }(await Ra2(t2), n)), () => {
...
var $a2 = class extends Jc2 {
  ...
  constructor(t2, e, n, s) {
     ...
     */
    this.type = "firestore", this._queue = new ka2(), this._persistenceKey = (null == s ? void 0 : s.name) || "[DEFAULT]";
  }
  _terminate() {
...
function La2(e, n) {
  ...
  if (!r._initialized) {
    const t2 = getDefaultEmulatorHost("firestore");
    if (t2) {
      const [e2, n2] = t2.split(":");
      Yc2(r, e2, parseInt(n2, 10));
    }
  }
  return r;
}
...
!function(t2, e = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(b, "3.6.0", t2), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
